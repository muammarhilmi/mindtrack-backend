          ...
          Expanded(
            child: Obx(() => ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _buildChatBubble(chat['text'], chat['isSender']);
              },
            )),
          ),
        ...
        children: [
          if (!isSender) ...[
            ...
            const CircleAvatar(
              ...
              child: Icon(Icons.share, size: 12, color: Colors.grey)
            ),
          ] else ...[
            _bubbleContainer(text, isSender),
          ],
  ...
  Widget _bubbleContainer(String text, bool isSender) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isSender ? const Color(0xFFF3E5F5) : const Color(0xFFE8F5E9),
